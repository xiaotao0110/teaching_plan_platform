$(function () {
    ...
    $("#studentDataGrid").datagrid({
        url: getBaseUrl() + $('#studentForm').attr('action'),
        ...
        columns: [[
            ...
            {field: "studentName", title: "名称", width: bodyWidth * 0.1},
            {
                ...
                formatter: function (value, row, index) {
                    return '<a style="color:blue" href="' + getBaseUrl() + 'student/studentDetails?professionId='
    ...
    function loadClasss() {
        ...
        //教学班号下拉框
        $('#classs').combobox({
            url: getBaseUrl() + "classs/classsSelect2?professionId=" + pid,
            headers: {"Authorization": "Bearer " + Cookies.get("token")},
            valueField: 'id',
            textField: 'text',
            width: 150,
